...
/**
 * The PatientProcessor class represents the processing of FHIR Patient resources including the
 ...
 */
@Slf4j
public class PatientProcessor extends ResourceProcessor<Patient> {

  /**
   * Constructor for objects of the class PatientProcessor.
   *
   ...
   */
  public PatientProcessor(PatientMapper mapper, IParser parser) {
    super(mapper, parser);
  }

  /**
   * Processes FHIR Patient resources and maps them to OMOP CDM.
   *
  ...
  public OmopModelWrapper process(FhirPsqlResource fhirPsqlResource) {
    ...
    var r = fhirParser.parseResource(Patient.class, fhirPsqlResource.getData());
