 ...
 */
@Slf4j
public class DiagnosticReportProcessor extends ResourceProcessor<DiagnosticReport> {
   ...
   */
  public DiagnosticReportProcessor(DiagnosticReportMapper mapper, IParser parser) {
    super(mapper, parser);
  }
  ...
  public OmopModelWrapper process(FhirPsqlResource fhirPsqlResource) {
    ...
    var r = fhirParser.parseResource(DiagnosticReport.class, fhirPsqlResource.getData());
