 ...
 */
@Slf4j
public class ConsentProcessor extends ResourceProcessor<Consent> {
   ...
   */
  public ConsentProcessor(ConsentMapper mapper, IParser parser) {
    super(mapper, parser);
  }
  ...
  public OmopModelWrapper process(FhirPsqlResource fhirPsqlResource) {
    ...
    var r = fhirParser.parseResource(Consent.class, fhirPsqlResource.getData());
