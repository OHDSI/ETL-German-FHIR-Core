...
/**
 * The OpsStandardDomainLookup class describes the structure of the ops_standard_domain_lookup view
 * in OMOP CDM. The ops_standard_domain_lookup view contains the mapping from OPS to standard
...
@Builder
@Entity
@IdClass(OpsStandardId.class)
@Table(name = "ops_standard_domain_lookup", schema = "cds_etl_helper")
public class OpsStandardDomainLookup {
